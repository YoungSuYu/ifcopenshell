...
duplex_window = get_features('ifcwindow', "./ifc/SVM/KBIMS_Sample_Mode.ifc")
duplex_window.to_csv("./result/KBIMS_Sample_Mode.ifc.csv")
...
duplex_all = get_building_ifc("./ifc/SVM/KBIMS_Sample_Mode.ifc.ifc")
duplex_all.to_csv("./result/KBIMS_Sample_Mode.ifc.csv")
